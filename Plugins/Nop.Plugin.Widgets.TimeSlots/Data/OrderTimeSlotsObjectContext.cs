...
{
    public class OrderTimeSlotsObjectContext : DbContext, IDbContext
    {
        #region ctor
        public OrderTimeSlotsObjectContext(DbContextOptions<OrderTimeSlotsObjectContext> options) : base(options)
        {
        ...
        {
            modelBuilder.ApplyConfiguration(new OrderTimeSlotsMap());
        ...
        {
            //drop the table
            this.DropPluginTable(nameof(OrderTimeSlots));
        }
